...
import type { LLMClient, ToolDefinition } from "../llm/types";
...
async function processQuery(options: CLIOptions, systemPrompt: string, query: string) {
...
async function runInteractive(options: CLIOptions, systemPrompt: string) {
